...
const Info = () => (
  <section id="info" className={`${styles.boxWidth} flex-row ${styles.flexCenterVert} ${styles.paddingY}`}>
    <div className={`md:flex hidden flex-1 ${styles.flexCenter} md:mr-20 ml-0 md:mt-0 mt-10 relative flex-col`}>
