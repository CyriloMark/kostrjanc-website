...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        {getCurrentLang() === "sb" ? "Štó my smy?" : "Wer wir sind?"}
      </h1>
      ...
      <div className={`flex flex-col justify-center items-center ss:px-0 px-2`}>
        <div className={`flex w-full md:flex-row flex-col ${styles.marginY}`}>
          <div className={`flex-1 flex ${styles.flexCenter}`}>
            <img
              src={kostrjanc_Cyril_Portait}
              alt="Portrait Cyril Mark"
              className={`w-[480px] z-[5]`}
            />
        ...
        <div
          className={`flex w-full md:flex-row-reverse flex-col ${styles.marginY}`}
        >
          <div className={`flex-1 flex  ${styles.flexCenter}`}>
            <img
              src={kostrjanc_Korla_Portait}
              alt="Portrait Korla Mark"
              className={`w-[480px] z-[5]`}
            />
          ...
          <div className={`z-[5] flex flex-1 flex-col ${styles.padding}`}>
            ...
            <p className={`${styles.paragraph} mt-5`}>
              {getCurrentLang() === "sb"
                ...
                : "Ich bin Korla Baier, 14 Jahre alt und aus Panschwitz. Ich gehe in die zehnte Klasse am Sorbischen Gymnazium in Bautzen. Ein Lieblingsfach ist Mathematik. Zurzeit ist mein größtes Hobby das Programmieren, ich spiele aber auch gerne Klavier und die Orgel. Bei kostrjanc bin ich für das Backend zuständig. Das heißt, dass ich mich um das Firebase System, Dashboardy Web Dienst kümmere. Das Projekt ist wichtig für mich, da ich durch das neue Erfahrungen sammeln kann. Ich möchte später nähmlich ein Programmierer werden. Aber auch das Zusammenarbeiten bereitet mir viel Spaß."}
            </p>
          </div>
        </div>
