      ...
      >
        ...
        >
          <div className="flex flex-col flex-1">
            ...
            <div className={`${styles.paragraph} max-w-[720px]`}>
              {getCurrentLang() == "sb" ? (
                <p>
                  Wabjenje na kostrjanc je cyle jednorje jedyn post abo jedyn
                  ewent. Hdyž sej wužiwar posty na kostrjanc wobhlada, wón
                  druhdy jedne wabjenje widźi. Tute wabjenje móže potom waš post
                  abo ewent być. Maće tež móžnosć waše wabjenje wusměrić, tak zo
                  so wabjenje jenož wužiwarjam pokaza kiž so za waše wabjenja
                  zajimuja.
                </p>
              ) : (
          ...
          <div className={`sm:flex flex-col hidden w-full ${styles.marginY}`}>
            ...
            <div className={`flex flex-row w-full ${styles.flexCenter}`}>
              ...
              <div className={`px-5 flex-1 flex`}>
                <h2
                  className={`font-barlow font-semibold text-center xs:text-[40px] text-[30px] xs:leading-[53px] leading-[43px] text-white text-center w-full`}
                >
                  {getCurrentLang() === "sb" ? "Werifikacija" : "Verifikation"}
                </h2>
              </div>
            </div>
            ...
            <div className={`flex flex-row w-full ${styles.flexStart}`}>
              ...
              >
                {getCurrentLang() == "sb" ? (
                  <p>
                    Jeli chceće so z čłonom wot kostrjanc buisness programom
                    stać, hdźe to cyle jednorje. Pisaće nam cyle jednorje jednu
                    email na{" "}
                    <a
              ...
              >
                {getCurrentLang() == "sb" ? (
                  <div>
                    Werifikacija je wosebita forma našeho Business programa.
                    Jako werifikowana wosoba dóstanješ móžnosć, na kostrjanc
                    wosebite nadawki spjelnić. Tohorunja maš móžnosć kostrjanc
                    sobu postajić a maš wosebite prawa, za agěrowanje w našej
                    ...
                    <ul className="list-disc w-full px-5 my-2">
                      ...
                      <li>
                        dźeržiš so na moralne normy a akceptuješ prawa a regule
                        w a zwonka kostrjanc
                      </li>
                      <li>
                    ...
                    , a napisaj do titula "werifikacija". Prošu podaj twoje
                    mjeno a dźeń naroda.
                  </div>
                ) : (
        ...
        >
          ...
          <div className={`${styles.paragraph} max-w-[720px]`}>
            {getCurrentLang() == "sb" ? (
              <p>
                Na kostrjanc buisness dashbordźe móžeće wabjenja wozjewić, sej
                waše aktualne wabjenja a kóšty wobhladać. Hdyž je so waš akawnt
                na jedyn Business Account změnił je, móžeće so na{" "}
                <a
                ...
                z wašim akawntom přizjewić. Za to wužiwaće samsne hesło a email
                kaž pola kostrjanc app. Horjeka nalěwo móžeće wšelake strony
                wuzwolić.
                <br />
                Na dashboardźe móžeće wšitke wabjenja widźeć, kotryž šće
                wozjewjeli. Móžeće widźeć kak husto je so wabjenje wobhladało.
        ...
        <div className={`${styles.paddingY} flex flex-col`}>
          ...
          <div className={`${styles.paragraph} max-w-[720px]`}>
            {getCurrentLang() == "sb" ? (
              <p>
                Na stronje "Nowe Wabjenje" móžeće nowe wabjenja wozjewić. Hdyž
